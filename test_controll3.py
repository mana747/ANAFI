...
if __name__ == '__main__':
    ...
    # pdraw.set_output_files(
    #         video=os.path.join("/home/manaki/code/parrot-groundsdk", "streaming.mp4"),
    #         metadata=os.path.join("/home/manaki/code/parrot-groundsdk", "streaming_metadata.json"),
    #     )
